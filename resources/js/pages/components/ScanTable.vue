        ...
        >
            ...
            <tbody class="divide-y divide-slate-100 dark:divide-slate-800/70">
                ...
                >
                    ...
                    <td
                        class="px-4 py-2.5 text-[11px] tracking-wide text-slate-500 uppercase dark:text-slate-400"
                    >
                        {{ scan.type }}
                    </td>
                    <td
                        class="max-w-[18rem] truncate px-4 py-2.5"
                        :title="scan.subject"
                    >
                        {{ scan.subject }}
                    </td>
                    ...
                    <td
                        v-if="!props.compact"
                        class="px-4 py-2.5 whitespace-nowrap text-slate-600 tabular-nums dark:text-slate-400"
                    >
                    ...
                    <td
                        class="px-4 py-2.5 text-right whitespace-nowrap text-slate-600 tabular-nums dark:text-slate-400"
                    >
